...
func parseFlags() Options {
	...
	flag.StringVar(&opts.Provider, "provider", "", "model provider override: openai, bedrock, anthropic, vertex, nowllm; defaults to instance configuration")
	flag.StringVar(&opts.Model, "model", "", "large model override from the instance registry, e.g. claude-opus-4-8; defaults to instance selection")
